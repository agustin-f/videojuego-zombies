...
var ZombieCaminante = function(sprite, x, y, ancho, alto, velocidad, rangoMov , desdeX , hastaX , desdeY , hastaY) {
  /* ZombieCaminante llama al constructor de Enemigo utilizando los parametros
  necesarios */
  Enemigo.call(this, sprite, x, y, ancho, alto, velocidad, rangoMov, desdeX, hastaX, desdeY, hastaY);
}
