...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_vertical.png', 500, 350, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 120, 400, 30, 30, 1),
    new Obstaculo('imagenes/auto_verde_abajo.png', 800, 400, 15, 30, 1),
    new Obstaculo('imagenes/auto_verde_derecha.png', 200, 420, 30, 15, 1)
  ...
  enemigos: [
       new Enemigo('imagenes/zombie1.png', 720, 60, 30, 30, 0.5,1),
       new Enemigo('imagenes/zombie2.png', 500, 450, 30, 30, 1 , 0.3,1),
       new Enemigo('imagenes/zombie3.png', 800, 230, 30, 30, 2 , 0.3,1),
       new Enemigo('imagenes/zombie2.png',900,330,30,30,0.2,1),
       new Enemigo('imagenes/zombie3.png',600,130,30,30,0.3,1),
       new Enemigo('imagenes/zombie4.png',500,230,30,30,0.2,1),
       new Enemigo('imagenes/zombie4.png',100,330,30,30,0.5,1),
       new Enemigo('imagenes/zombie4.png',800,530,30,30,0.1,1),
       new Enemigo('imagenes/zombie3.png',570,430,30,30,0.6,1),
       new Enemigo('imagenes/zombie4.png',1000,130,30,30,0.1,1),
       new Enemigo('imagenes/zombie2.png',1200,30,30,30,0.1,1),
       new Enemigo('imagenes/zombie1.png',1170,530,30,30,0.1,1)
  ],

  trenes: [
      new ZombieConductor('imagenes/tren_vertical.png',644,0,30,90,0.1,0,1),
      new ZombieConductor('imagenes/tren_vertical.png',673,0,30,90,0.1,0.5),
      new ZombieConductor('imagenes/tren_horizontal.png',400,322,90,30,2,0)
  ]
...
Juego.dibujar = function() {
  ...
  this.enemigos.forEach(function(enemigo) {
   ...
   // Se recorren los trenes de la carretera pintandolos
  this.trenes.forEach(function(ZombieConductor) {
    Dibujante.dibujarEntidad(ZombieConductor);
  });
...
Juego.moverEnemigos = function() {
 ...
 // Se recorren los trenes de la carretera moviendolos
 Juego.moverTrenes = function(){
  this.trenes.forEach(function(ZombieConductor) {
    ZombieConductor.moverTren();  
  });
};
...
Juego.calcularAtaques = function() {
  this.enemigos.forEach(function(enemigo) {
    if (this.intersecan(enemigo, this.jugador, this.jugador.x, this.jugador.y)) {
      ...
      COMPLETAR */ enemigo.comenzarAtaque(this.jugador);
